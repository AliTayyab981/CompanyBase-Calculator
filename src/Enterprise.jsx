import { Box, Button, Card, Flex, Input, Stack, Text, Tooltip } from '@chakra-ui/react'
...
const Enterprise = () => {
    ...
    const [costperappoitment, setcostperappoitment] = useState(1000)
    useEffect(() => {
        if (isseleect == "BusinessConsulting") {
            setFirstRange(5)
            setcostperappoitment(1500)
        }
        else if (isseleect == "CPG") {
            setFirstRange(5)
            setcostperappoitment(1000)
        }
        else if (isseleect == "Cybersecurity") {
            setFirstRange(5)
            setcostperappoitment(2000)
        }
